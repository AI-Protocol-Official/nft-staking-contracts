# AI Protocol NFT Staking #
Enables NFT staking for a given NFT smart contract defined on deployment
...
* NFT Staking
    * Smart Contract(s):
        * [NFTStaking](contracts/protocol/NFTStaking.sol) – NFTStaking implementation
    * Test(s):
      * [nft_staking.js](test/protocol/nft_staking.js) – functional requirements tests
...
1. Clone the repository  
    ```git clone git@github.com:AI-Protocol-Official/nft-staking-contracts.git```
2. Navigate into the cloned repository  
    ```cd nft-staking-contracts```
